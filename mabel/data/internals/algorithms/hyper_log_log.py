...
This is a variation of a Hyper Log Log; this provides a fast and memory efficient way
to estimate cardinality of a list.
...
Implementation derived from from: https://github.com/svpcom/hyperloglog
"""
...
class HyperLogLog(object):
    ...
    def update(self, *others):
        ...
        self.M = [
            max(*items) for items in zip(*([item.M for item in others] + [self.M]))
        ]
