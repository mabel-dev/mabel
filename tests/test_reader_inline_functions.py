...
def test_inline_date_functions():
    ...
    assert inline_functions.add_days("2021-01-10T10:12:03", 10) == datetime.datetime(2021,1,20,10,12,3)
    assert inline_functions.add_days("2021-01-02T00:00", -10) == datetime.datetime(2020,12,23,0,0)
